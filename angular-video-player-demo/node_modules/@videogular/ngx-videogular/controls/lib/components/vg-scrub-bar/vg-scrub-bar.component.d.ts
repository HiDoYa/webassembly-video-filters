...
export declare class VgScrubBarComponent implements OnInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<VgScrubBarComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<VgScrubBarComponent, "vg-scrub-bar", never, { "vgSlider": "vgSlider"; "vgFor": "vgFor"; }, {}, never, ["*"]>;
}
