...
export declare class VgVolumeComponent implements OnInit, OnDestroy {
    ...
    getVolume(): number;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<VgVolumeComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<VgVolumeComponent, "vg-volume", never, { "vgFor": "vgFor"; }, {}, never, never>;
}
